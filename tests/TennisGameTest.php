...
final class TennisGameTest extends TestCase
{
     ...
     * @test
     */
    public function si_tenia_ventaja_jugador1_pero_ahora_van_iguales_devuelve_forty_all()
    {
        $tennisGame = new TennisGame("player1", "player2");
     ...
     * @test
     */
    public function si_tenia_ventaja_jugador2_pero_gana_jugador1_devuelve_win_player1()
    {
        $tennisGame = new TennisGame("player1", "player2");
